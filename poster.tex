...
% + this template github: https://github.com/DHGraz/baposter_unigraz_dh
% 10/2025

\documentclass[a0paper,portrait]{baposter}
\usepackage{comment}
\usepackage{multicol}
\usepackage{hyperref} % for \url (NPR: better avoid - \url{} produces unsightly artefacts in other boxes!)
\usepackage{lmodern}
...
\begin{document}
\begin{poster} % IMPORTANT: no empty lines between poster args { <config> }{ <eye-catcher> }{ <title> }{ <authors }{ <uni_logo> }
{
